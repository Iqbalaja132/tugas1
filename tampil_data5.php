...
<body>
    ...
    <h2>Latihan Menampilkan Data Siswa Yang Lahir Dibulan April</h2>
    <div class="box">
    ...
    foreach ($siswa as $murid) :
        $bulanLahir = date("F", strtotime($murid['tanggal_lahir']));
        if ($bulanLahir == 'April') : // Filter siswa yang lahir di bulan April
